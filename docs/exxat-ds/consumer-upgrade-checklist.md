...
Runs **`sync-extras`** (Cursor/Claude skills, rules, hooks, **`docs/exxat-ds/`**) and ports safe package-owned shell files from **`template-vite/`** in one install-like pass. Does **not** overwrite your product routes, mock data, or hub content.
